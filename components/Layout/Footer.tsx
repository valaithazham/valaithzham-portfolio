    ...
    <div className="bg-white-300 pt-44 pb-24">
      <div className="max-w-screen-xl w-full mx-auto px-6 sm:px-8 lg:px-16 grid grid-rows-6 sm:grid-rows-1 grid-flow-row sm:grid-flow-col grid-cols-3 sm:grid-cols-12 gap-4">
        <div className="row-span-2 sm:col-span-4 col-start-1 col-end-4 sm:col-end-5 flex flex-col items-start ">
          ...
          <h1 className="h-8 w-auto mb-6 text-xl font-bold">
          <img
          ...
          <p className="mb-4">
            <strong className="font-medium">Valaithazham</strong> is a team of freelance website designers brought together by a journey that began during our engineering days.
          </p>
          {/* Social Media Icons */}
          ...
          <p className="text-gray-400">©{new Date().getFullYear()} - Valaithazham</p>
        </div>
